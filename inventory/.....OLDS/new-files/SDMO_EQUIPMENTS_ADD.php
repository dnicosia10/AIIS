...
<fieldset><legend>Fill up Equipments Information</legend><form action="" method="POST">
	...
	Name:<span class="error"><?php echo $error1 ?></span>
		<input type="text" name="name" placeholder="ex: Ball, Shoes, Armor..." class="form-control">
	...
	Equipment Type:<span class="error"><?php echo $error5 ?></span>
		<input type="text" name="type" placeholder="ex: Basketball, Volleyball ..." class="form-control">

	Brand:<span class="error"><?php echo $error3 ?></span>
		<input type="text" name="brand"  class="form-control">

	Date:<span class="error"><?php echo $error6 ?></span>
		<input type="date" name="date"  class="form-control">



	
  	<input type="submit" name="submit" value="Add" class="btn btn-success" style="width: 200px;margin-top: 5px;">
</form></fieldset>
</body>
</html>